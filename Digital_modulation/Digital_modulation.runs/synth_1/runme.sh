...
HD_PWD='C:/Users/yuanjiajun/Desktop/project_729/Digital_modulation/Digital_modulation.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log digital_modulation.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source digital_modulation.tcl
